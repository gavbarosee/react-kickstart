...
export function getStyledComponentsApp(
  ...
  // For Next.js app router, we need the 'use client' directive
  ...
  // Different component structure based on framework
  if (framework === "vite") {
  ...
  `;
    ...
    // Default for other frameworks (Parcel, Rsbuild, Next.js pages)
    return `${imports}const Container = styled.div\`
    max-width: 1200px;
    margin: 0 auto;
    padding: 2rem;
